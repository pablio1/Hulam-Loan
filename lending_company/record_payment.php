	...
	if(isset($_POST['update'])){
		...
		$q->execute();
	   	if($q->rowCount()== 0){
	        ...
	        $sql="INSERT INTO loan_features(lender_id,min_loan,max_loan,min_term,max_term,fix_rate,late_charges)
	        VALUES(:lender_id,:min_loan,:max_loan,:min_term,:max_term,:fix_rate,:late_charges)";
	        ...
	        $sql="UPDATE loan_features SET min_loan=:min_loan,max_loan=:max_loan,min_term=:min_term,max_term=:max_term,fix_rate=:fix_rate,late_charges=:late_charges WHERE lender_id = :lender_id";
	        $query =$dbh->prepare($sql);
	        $query->bindParam(':lender_id',$lender_id,PDO::PARAM_STR);
	        $query->bindParam(':min_loan',$min_loan,PDO::PARAM_STR);
	        $query->bindParam(':max_loan',$max_loan,PDO::PARAM_STR);
														...
														<form>	
															<div class="card-body">
																<div class="form-group row">
																	<label class="col-3 col-form-label">Loan Account No:</label>
																	<div class="col-9">
