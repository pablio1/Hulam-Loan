														...
														<div class="card-header">
															...
															<div class="card-toolbar">
																<div class="example-tools justify-content-center">
																	<a href="lending_company/released_loan.php" class="btn btn-secondary"><< Back</a>
																</div>
															</div>
														</div>
														<!--begin::Form-->
															...
															<div class="card-body">
																<div class="alert alert-custom alert-default" role="alert">
																	<div class="alert-text">
																		...
																		<label class="text-lg">Remaining Balance:&nbsp;&nbsp;</label>
																			...
																			<div class="col-md-12 bg-light text-center">
																					...
																					<tbody>
																						...
																						<tr>
																							...
																							<td><label class="text-lg"><?= number_format($loan['late_charge'], 2)?></td>
																						</tr>
																						<tr>
																							<td><label class="text-lg">Advance Payment(Bi-Monthly)</td>
																						
																							<td><label class="text-lg"></td>
																						</tr>
																					</tbody>
																				</table>
																			</div>
																...
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<input name="amount_paid" class="form-control" type="number" required/>
																	</div>
																</div>
																<div class="form-group row">
																	...
																	<input type="hidden" name="debtor_id" value="<?= $loan['debtor_id']?>">
																	</div>
																</div>
															</div>
