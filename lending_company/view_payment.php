...
if(isset($_POST['submit'])){
    ...
    $pay = intval($_GET['loan_payment_id']);

    $sql = "UPDATE payment_details SET confirm = :confirm WHERE loan_payment_id = $pay ";
    ...
    if($query->execute())
        {
            ...
            window.location.href=(lending_company/index.php);
            </script>
            <?php
        }else{
        ?>
            <script>
            alert("error");
            window.location.href=(lending_company/ndex.php);
            </script>
            <?php
														...
														<form action="" method="post">
															<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
																...
																<div class="row">
																	<div class="col-lg-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="loan_id" value="<?= $rem['loan_id']; ?>"/>
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="l_name" value="<?= $rem['l_name']; ?>"/>
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label>First Name</label>
																			<input type="text" class="form-control " name="f_name" value="<?= $rem['f_name']; ?>"/>
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="m_name" value="<?= $rem['m_name']; ?>"/>
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label>Phone No:</label>
																			<input type="text" class="form-control " name="phone_no" value="<?= $rem['phone_no']; ?>"/>
																		</div>
																	</div>
																</div>
                                                                ...
                                                                <div class="row">
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label>Lending Company Name</label>
																			<input type="text" class="form-control " name="lending_company_name" value="<?= $rem['lending_company_name']; ?>"/>
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label>Bank Name:</label>
																			<input type="text" class="form-control " name="bank_name" value="<?= $rem['bank_name']; ?>"/>
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-lg-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="bank_account_no" value="<?= $rem['bank_account_no']; ?>"/>
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label>Payment Reference No:</label>
																			<input type="text" class="form-control " name="reference_no" value="<?= $rem['reference_no']; ?>"/>
																		</div>
																	</div>
																</div>
																<div class="row">
																	<div class="col-xl-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="amount_paid" value="<?= $rem['amount_paid']; ?>"/>
																		</div>
																	</div>
																	<div class="col-xl-6">
																		<div class="form-group">
																			<label>Date Of Payment</label>
																			<input type="text" class="form-control " name="payment_date" value="<?= $rem['payment_date']; ?>"/>
																		</div>
																	</div>
																</div>
                                                                <div class="row">
                                                                    <div class="col-xl-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="posted_date" value="<?= $rem['posted_date']; ?>"/>
																		</div>
																	</div>
                                                                </div>
															</div>
															<div class="d-flex justify-content-between border-top mt-5 pt-10">
																...
																<div>
																	<button type="submit" name="submit" class="btn btn-success font-weight-bolder px-10 py-3" data-wizard-type="action-submit">Confirm Payment
																	</button>
																</div>
															</div>
															<!--end: Wizard Actions-->
