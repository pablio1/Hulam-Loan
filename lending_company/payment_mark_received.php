...
//         header("Location: payment_mark_received.php");
//         exit();
//     }else{
										...
										<div class="card-body">
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														$sql = "SELECT * FROM uploadfile_payment INNER JOIN user ON uploadfile_payment.lender_id = user.user_id WHERE uploadfile_payment.lender_id  = $lender_id AND uploadfile_payment.file_status = 'Received'";
														$query = $dbh->prepare($sql);
														$query->execute();
														...
														foreach ($res as $rem):?>
															<tr>
																...
																<td class="text-prinary"><?= $rem['file_status']?></td>
															</tr>
															<?php endforeach;?>
															</tbody>
						...
						<div class="modal-dialog modal-dialog-centered modal-xs" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<input type="text" name="file_id" value="<?= $rem['file_id'];?>">
								</div>
