											...
											<div class="dropdown-menu dropdown-menu-right">
												<ul class="kt-nav">
													...
													<li class="kt-nav__item">
														<a href="debtor/view_statement.php?<?= $get['loan_app_id'] ?>" onclick="download_statement_as_csv('view_statement');" class="kt-nav__link">
											...
											<div class="col-md-9">
												...
												<div class="d-flex justify-content-between text-white pt-6">
													...
													<div class="d-flex flex-column flex-root">
														...
														<span class="opacity-70"><?= $res['loan_amount']; ?></span><br />
														<span class="font-weight-bolder mb-2">MONTHLY AMORTIZATION</span>
														<span class="opacity-70"><?= $res['monthly_payment']; ?></span>
													</div>
												</div>
											</div>
										</div>
										<div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
											<div class="col-md-9">
												...
												<table class="table">
													...
													<tbody>
														<tr class="font-weight-boldest font-size-l">
															...
															?>
															<td><?= $res['monthly_payment'] - ($res['total_interest'] / $res['loan_term']); ?></td>
															<td>
																<?= $res['total_interest'] / $res['loan_term'] ?>
															</td>
															<td><?= $res['monthly_payment']; ?></td>
															<td><?= $final; ?></td>
															<td><?= $res['monthly_payment']; ?></td>
														</tr>
													</tbody>
												...
												<div class="d-flex flex-column text-md-right">
													...
													<span class="font-size-h4 font-weight-boldest text-danger mb-1"><?= $res['monthly_payment']; ?></span>
												</div>
												<div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
													<table class="table">
														<thead style="background-color:DodgerBlue;">
