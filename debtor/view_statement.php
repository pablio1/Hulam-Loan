				...
				<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<h4 class="text-white font-weight-bold my-1 mr-5"></h4>
								<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
									<li class="breadcrumb-item">
										<a href="" class="text-dark-50"></a>
									</li>
									<li class="breadcrumb-item">
										<a href="" class="text-dark-50"></a>
									</li>
											...
											<div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
												...
												<table class="table">
													...
													<tbody>
														...
														?>
																<tr class="font-weight-boldest font-size-l">
																	<td><?= htmlentities($returns->date_paid); ?></td>
											...
											<div class="d-flex flex-column text-md-right">
												<span class="font-size-lg font-weight-bolder mb-1">TOTAL AMOUNT PAID</span>
													<span class="font-size-h4 font-weight-boldest text-danger mb-1">&#8369;
														...
														$stmt = "SELECT SUM(amount_paid) AS value_sum FROM loan_payment WHERE loan_payment.loan_app_id  = $id";
														$st = $dbh->prepare($stmt);
														$st->execute();
