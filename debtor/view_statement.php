																	...
																	<div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
																		<div class="d-flex flex-column flex-root">
																			<h2 class="display-4 text-white font-weight-boldest mb-4">STATEMENT OF ACCOUNT
																				<?php
																					$loan_id = intval($_GET['id']);
																					$sql ="SELECT loan_application.*, user.* FROM loan_application INNER JOIN user ON loan_application.lender_id = user.user_id WHERE loan_application.id = $loan_id";
																					$query = $dbh->prepare($sql);
																					$query->execute();
																					$res = $query->fetch();
																				?>
																				<?php
																					$loan_id = intval($_GET['id']);
																					$sql ="SELECT loan_application.*, user.* FROM loan_application INNER JOIN user ON loan_application.debtor_id = user.user_id WHERE loan_application.id = $loan_id";
																					$query = $dbh->prepare($sql);
																					$query->execute();
																					$result = $query->fetch();
																				?>
																		...
																		<div class="d-flex justify-content-between text-white pt-6">
																			<div class="d-flex flex-column flex-root">
																				...
																				<span class="opacity-70"><?= $res['id'];?></span><br/>
																				...
																				<span class="opacity-70"><?= $res['total_amount'];?></span><br/>
																				<span class="font-weight-bolder mb-2">MONTHLY AMORTIZATION</span>
																				<span class="opacity-70"><?= $res['monthly_payable'];?></span>
																			</div>
																			<div class="d-flex flex-column flex-root">
																				...
																				<span class="opacity-70"><?= $result['c_street'].' '.$result['c_barangay'].' '.$result['c_city'].' '.$result['c_province'].' '.$result['c_zipcode'];?></span>
																			</div>
																			<div class="d-flex flex-column flex-root">
																				<span class="font-weight-bolder mb-2">LENDER DETAILS</span>
																				<span class="opacity-70"><?= $res['company_name'];?></span>
																				<span class="opacity-70">Mobile: <?= $res['mobile'];?></span>
																				<span class="opacity-70">Landline: <?= $res['landline'];?></span><br />
																				<span class="font-weight-bolder mb-2">ADDRESS</span>
																				<span class="opacity-70"><?= $res['c_street'].' '.$res['c_barangay'].' '.$res['c_city'].' '.$res['c_province'].' '.$res['c_zipcode'];?></span>
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<label class="font-weight-boldest border-bottom-0 font-size-l text-uppercase">As of <?= date('m-d-Y');?></label></br>
																		...
																		<table class="table">	
																			<thead style="background-color:DodgerBlue;">
																				...
																				<tr>
																					<th class="font-weight-boldest border-bottom-0 font-size-l text-uppercase">Principal Amount</th>
																					<th class="font-weight-boldest border-bottom-0 font-size-l text-uppercase">Loan Term</th>
																					<th class="font-weight-boldest border-bottom-0 font-size-l text-uppercase">Monthly Payment</th>
																					<th class="font-weight-boldest border-bottom-0 font-size-l text-uppercase">Due Date</th>
																					<th class="font-weight-boldest border-bottom-0 font-size-l text-uppercase">Amount</th>
																				</tr>
																			...
																			<tbody>
																				<tr class="font-weight-boldest font-size-l">
																					...
																					<td><?= $res['months'];?>&nbsp;Months</td>
																					<td><?= $res['monthly_payable'];?></td>
																					<td><?= $final;?></td>
																					<td><?= $res['monthly_payable'];?></td>
																				</tr>
																			</tbody>
																		...
																		<div class="d-flex flex-column text-md-right">
																			...
																			<span class="font-size-h4 font-weight-boldest text-danger mb-1"><?= $res['monthly_payable'];?></span>
																		</div>
																		<div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
																			<table class="table">	
																				<thead style="background-color:DodgerBlue;">
																				...
																				<tbody>
																					...
																					$sql = "SELECT * FROM payment_details INNER JOIN loan_application ON loan_application.id = payment_details.loan_id INNER JOIN user ON payment_details. remittance_id = user.user_id WHERE loan_application.id = $id";
																					$query =$dbh->prepare($sql);
																					$query->execute();
																		...
																		<div class="d-flex flex-column text-md-right">
																			...
																			<span class="font-size-h4 font-weight-boldest text-danger mb-1">
																				...
																				$stmt = "SELECT SUM(amount_paid) AS value_sum FROM payment_details INNER JOIN loan_application ON payment_details.loan_id = loan_application.id WHERE loan_application.id  = $id";
																				$st = $dbh->prepare($stmt);
																				$st->execute();
