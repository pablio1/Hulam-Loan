...
if (isset($_POST['next'])) {
    ...
    if (empty($company_name) || empty($monthly_salary) || empty($company_landline) || empty($company_street) || empty($company_barangay) || empty($company_city) || empty($company_province) || empty($company_zipcode)) {
        header('location: update_income.php?company_name=' . $company_name . '&monthly_salary=' . $monthly_salary . '&company_mobile=' . $company_mobile . '&company_email=' . $company_email . '&company_mobile=' . $company_mobile . '&company_landline=' . $company_landline . '&company_street=' . $company_street . '&company_barangay=' . $company_barangay . '&company_city=' . $company_city . '&company_province=' . $company_province . '&company_zipcode=' . $company_zipcode . '&c_street=' . $c_street . '&c_barangay=' . $c_barangay . '&c_city=' . $c_city . '&c_province=' . $c_province . '&c_zipcode=' . $c_zipcode . '&p_street=' . $p_street . '&p_barangay=' . $p_barangay . '&p_city=' . $p_city . '&p_province=' . $p_province . '&p_zipcode=' . $p_zipcode . '&lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e=Please fill up all the required fields!');
        exit();
    }
    if (!empty($company_mobile) && strlen($company_mobile) < 11) {
        header('location: update_income.php?company_name=' . $company_name . '&monthly_salary=' . $monthly_salary . '&company_email=' . $company_email . '&company_mobile=' . $company_mobile . '&company_landline=' . $company_landline . '&company_street=' . $company_street . '&company_barangay=' . $company_barangay . '&company_city=' . $company_city . '&company_province=' . $company_province . '&company_zipcode=' . $company_zipcode . '&c_street=' . $c_street . '&c_barangay=' . $c_barangay . '&c_city=' . $c_city . '&c_province=' . $c_province . '&c_zipcode=' . $c_zipcode . '&p_street=' . $p_street . '&p_barangay=' . $p_barangay . '&p_city=' . $p_city . '&p_province=' . $p_province . '&p_zipcode=' . $p_zipcode . '&lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e=Please enter a valid mobile number!');
        exit();
    }
    if (!empty($company_email) && !filter_var($company_email, FILTER_VALIDATE_EMAIL)) {
        header('location: update_income.php?company_name=' . $company_name . '&monthly_salary=' . $monthly_salary . '&company_mobile=' . $company_mobile . '&company_mobile=' . $company_mobile . '&company_landline=' . $company_landline . '&company_street=' . $company_street . '&company_barangay=' . $company_barangay . '&company_city=' . $company_city . '&company_province=' . $company_province . '&company_zipcode=' . $company_zipcode . '&c_street=' . $c_street . '&c_barangay=' . $c_barangay . '&c_city=' . $c_city . '&c_province=' . $c_province . '&c_zipcode=' . $c_zipcode . '&p_street=' . $p_street . '&p_barangay=' . $p_barangay . '&p_city=' . $p_city . '&p_province=' . $p_province . '&p_zipcode=' . $p_zipcode . '&lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e=Please enter a valid email!');
        exit();
    }
}
...
if (isset($_GET['e'])) {
    ...
    $c_street = $_GET['c_street'];
    $c_barangay = $_GET['c_barangay'];
    $c_city = $_GET['c_city'];
    $c_province = $_GET['c_province'];
    $c_zipcode = $_GET['c_zipcode'];
    $p_street = $_GET['p_street'];
    $p_barangay = $_GET['p_barangay'];
    $p_city = $_GET['p_city'];
    $p_province = $_GET['p_province'];
    $p_zipcode = $_GET['p_zipcode'];
    $company_name = $_GET['company_name'];
    $monthly_salary = $_GET['monthly_salary'];
    $company_mobile = $_GET['company_mobile'];
    $company_landline = $_GET['company_landline'];
    $company_email = $_GET['company_email'];
    $company_street = $_GET['company_street'];
    $company_barangay = $_GET['company_barangay'];
    $company_city = $_GET['company_city'];
    $company_province = $_GET['company_province'];
    $company_zipcode = $_GET['company_zipcode'];
}
                                    ...
                                    <div class="offset-xxl-2 col-xxl-8">
                                        ...
                                        <form action="debtor/logic/update_information.php" method="post" id="kt_form" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                                            <select name="type_id" class="form-control form-control-solid form-control-lg">
                                                                <option value="" hidden>Type of ID</option>
                                                                <option <?php if (isset($_GET['e'])) {
                                                                            if ($_GET['type_id'] == 'SSS/UMID ID') {
                                                                                echo 'selected';
                                                                            }
                                                                        } else {
                                                                            if ($_SESSION['type_id'] == 'SSS/UMID ID') {
                                                                                echo 'selected';
                                                                            }
                                                                        } ?>>SSS/UMID ID</option>
                                                                <option <?php if (isset($_GET['e'])) {
                                                                            if ($_GET['type_id'] == 'POSTAL ID') {
                                                                                echo 'selected';
                                                                            }
                                                                        } else {
                                                                            if ($_SESSION['type_id'] == 'POSTAL ID') {
                                                                                echo 'selected';
                                                                            }
                                                                        } ?>>POSTAL ID</option>
                                                                <option <?php if (isset($_GET['e'])) {
                                                                            if ($_GET['type_id'] == 'PASSPORT ID') {
                                                                                echo 'selected';
                                                                            }
                                                                        } else {
                                                                            if ($_SESSION['type_id'] == 'PASSPORT ID') {
                                                                                echo 'selected';
                                                                            }
                                                                        } ?>>PASSPORT ID</option>
                                                            </select>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Valid ID</label>
                                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                                            <input type="file" name="proof_id" class="dropzone-select btn btn-light-primary font-weight-bold" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="rel_type" value="<?= isset($_GET['e']) ? $_GET['rel_type'] : $_SESSION['rel_type'] ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Fullname:</label>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="rel_name" value="<?= isset($_GET['e']) ? $_GET['rel_name'] : $_SESSION['rel_name'] ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control form-control-solid form-control-lg" name="rel_mobile" value="<?= isset($_GET['e']) ? $_GET['rel_mobile'] : $_SESSION['rel_mobile'] ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <input type="hidden" name="c_street" value="<?= $c_street ?>">
                                            <input type="hidden" name="c_barangay" value="<?= $c_barangay ?>">
                                            <input type="hidden" name="c_city" value="<?= $c_city ?>">
                                            <input type="hidden" name="c_province" value="<?= $c_province ?>">
                                            <input type="hidden" name="c_zipcode" value="<?= $c_zipcode ?>">
                                            <input type="hidden" name="p_street" value="<?= $p_street ?>">
                                            <input type="hidden" name="p_barangay" value="<?= $p_barangay ?>">
                                            <input type="hidden" name="p_city" value="<?= $p_city ?>">
                                            <input type="hidden" name="p_province" value="<?= $p_province ?>">
                                            <input type="hidden" name="p_zipcode" value="<?= $p_zipcode ?>">
                                            <input type="hidden" name="company_name" value="<?= $company_name ?>">
                                            <input type="hidden" name="monthly_salary" value="<?= $monthly_salary ?>">
                                            <input type="hidden" name="company_mobile" value="<?= $company_mobile ?>">
                                            <input type="hidden" name="company_landline" value="<?= $company_landline ?>">
                                            <input type="hidden" name="company_email" value="<?= $company_email ?>">
                                            <input type="hidden" name="company_street" value="<?= $company_street ?>">
                                            <input type="hidden" name="company_barangay" value="<?= $company_barangay ?>">
                                            <input type="hidden" name="company_city" value="<?= $company_city ?>">
                                            <input type="hidden" name="company_province" value="<?= $company_province ?>">
                                            <input type="hidden" name="company_zipcode" value="<?= $company_zipcode ?>">

                                            <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                                <div>
                                                    <a class="btn btn-secondary font-weight-bolder px-10 py-3" href="<?= 'debtor/update_income.php?company_name=' . $company_name . '&monthly_salary=' . $monthly_salary . '&company_mobile=' . $company_mobile . '&company_email=' . $company_email . '&company_mobile=' . $company_mobile . '&company_landline=' . $company_landline . '&company_street=' . $company_street . '&company_barangay=' . $company_barangay . '&company_city=' . $company_city . '&company_province=' . $company_province . '&company_zipcode=' . $company_zipcode . '&c_street=' . $c_street . '&c_barangay=' . $c_barangay . '&c_city=' . $c_city . '&c_province=' . $c_province . '&c_zipcode=' . $c_zipcode . '&p_street=' . $p_street . '&p_barangay=' . $p_barangay . '&p_city=' . $p_city . '&p_province=' . $p_province . '&p_zipcode=' . $p_zipcode . '&lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e' ?>">Back</a>
                                                </div>
                                                <div>
