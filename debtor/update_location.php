...
if (isset($_POST['next'])) {
    ...
    if (empty($lname) || empty($fname) || empty($mname) || empty($gender) || empty($b_day) || empty($mobile) || empty($landline)) {
        header('location: update_information.php?lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e=Please fill up all the fields!');
        exit();
    }
    if (strlen($mobile) != 11) {
        header('location: update_information.php?lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&landline=' . $landline . '&e=Mobile number must be 11 characters long!');
        exit();
    }
    if (strlen($landline) != 7) {
        header('location: update_information.php?lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&e=Landline number must be 7 characters long!');
        exit();
    }
    if ($b_day > date('Y-m-d')) {
        header('location: update_information.php?lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&mobile=' . $mobile . '&landline=' . $landline . '&e=Please enter a valid birthday!');
        exit();
    }
}
                            ...
                            <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
                                <div class="row">
                                    <div class="offset-xxl-2 col-xxl-8">
                                        ...
                                        <form action="debtor/update_income.php" method="post" id="kt_form" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xl-6">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="c_street" value="<?= isset($_GET['e']) ? $_GET['c_street'] : $_SESSION['c_street'] ?>" placeholder="Enter street" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Barangay</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="c_barangay" value="<?= isset($_GET['e']) ? $_GET['c_barangay'] : $_SESSION['c_barangay'] ?>" placeholder="Enter barangay" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="c_city" value="<?= isset($_GET['e']) ? $_GET['c_city'] : $_SESSION['c_city'] ?>" placeholder="Enter city" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Province</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="c_province" value="<?= isset($_GET['e']) ? $_GET['c_province'] : $_SESSION['c_province'] ?>" placeholder="Enter barangay" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="c_zipcode" value="<?= isset($_GET['e']) ? $_GET['c_zipcode'] : $_SESSION['c_zipcode'] ?>" placeholder="Enter zipcode" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Street</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="p_street" value="<?= isset($_GET['e']) ? $_GET['p_street'] : $_SESSION['p_street'] ?>" placeholder="Enter street" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Barangay</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="p_barangay" value="<?= isset($_GET['e']) ? $_GET['p_barangay'] : $_SESSION['p_barangay'] ?>" placeholder="Enter barangay" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>City/Municipality</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="p_city" value="<?= isset($_GET['e']) ? $_GET['p_city'] : $_SESSION['p_city'] ?>" placeholder="Enter city" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Province</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="p_province" value="<?= isset($_GET['e']) ? $_GET['p_province'] : $_SESSION['p_province'] ?>" placeholder="Enter barangay" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Zip Code</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="p_zipcode" value="<?= isset($_GET['e']) ? $_GET['p_zipcode'] : $_SESSION['p_zipcode'] ?>" placeholder="Enter zipcode" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                                <div>
                                                    <a class="btn btn-secondary font-weight-bolder px-10 py-3" href="<?= 'debtor/update_information.php?lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e' ?>">Back</a>
                                                </div>
                                                <div>
