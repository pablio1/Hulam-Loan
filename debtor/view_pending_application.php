...
<?php
	if(isset($_POST['valid_id'])){
		...
		if($query){
			$_SESSION['status_pending'] = "Success";
			header("location: view_pending_application.php?loan_app_id=$loan_app_id");
			exit();
		}else{
			$_SESSION['status_pending'] = "Error!";
			header("location: view_pending_application.php?loan_app_id=$loan_app_id");
			exit();
		}
	}
								...
								<div class="card-body p-0">
									<div class="card card-custom gutter-b">
                                        ...
                                        <div class="col-xl-6 col-xl-6">
                                            <?php
                                            if (isset($_SESSION['status_pending'])) {
                                            ?>
                                                <div class="alert alert-custom alert-notice alert-light-success fade show" role="alert">
                                                    <div class="alert-text">
                                                        <h4><?php echo $_SESSION['status_pending']; ?></h4>
                                                    </div>
                                                    <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                                </div>
                                            <?php unset($_SESSION['status_pending']);
                                            } ?>
                                        </div>
                                        <?php
												$loan_app_id = intval($_GET['loan_app_id']);
															...
															<h5 class="text-info font-weight-bolder">Reminders:</h5>
																<div class="col-lg-12 col-xl-12">
																	<p class="font-weight-bolder font-size-lg py-4">
																		...
																		▸ Please comply all the required documents to complete the loan application.</br>
