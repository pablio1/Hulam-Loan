												...
												<div class="card-body d-flex flex-column">
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-h5">Loan Information</a>
															<span class="font-weight-bolder text-primary">as of <?= date('M d, Y') ?> 08:00 AM</span>
														</div>
													</div>
													<div class="card-footer d-flex align-items-center justify-content-between flex-wrap py-4">
														<h3>Remaining Balance: &nbsp; PHP 
														<?= number_format($loan['remaining_balance'],2) ?></h3>
													</div>
												</div>
												<div class="card-footer d-flex align-items-center justify-content-between flex-wrap py-4" >
										     ...
										     <div class="form-group">
												<div class="card card-custom card-stretch card-stretch-half gutter-b">
													<div class="card-body d-flex flex-column">
														...
														<div class="card-footer d-flex align-items-center justify-content-between flex-wrap py-4">
															<h3>Amount Due:&nbsp;PHP <?= number_format($loan['monthly_payable'],2) ?></h3>
														</div>
													</div>
													<div class="card-footer d-flex align-items-center justify-content-between flex-wrap py-4">
														<div class="symbol-group symbol-hover py-1 mr-2">
