                            ...
                            <div class="card-body">
                                <div class="card-header align-items-center px-4 py-3">
                                    ...
                                    <div class="text-center flex-grow-1">
                                        <div class="text-dark-75 font-weight-bold font-size-h5">Hi <?= $_SESSION['firstname']?>, How can we help you? </div>
                                    </div>
                                </div>
                                <!--begin::Compose-->
                                <form action="" method="post">
                                    <textarea class="form-control border-0 p-0" rows="2" placeholder="Type a message" name="message" style="font-size: large;"></textarea>
                                        <input type="hidden" name="date_message" value="<?php echo date('Y-m-d'); ?>">
