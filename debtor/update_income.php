...
if (isset($_POST['next'])) {
    ...
    if (empty($c_street) || empty($c_barangay) || empty($c_city) || empty($c_province) || empty($c_zipcode) || empty($p_street) || empty($p_barangay) || empty($p_city) || empty($p_province) || empty($p_zipcode)) {
        header('location: update_location.php?c_street=' . $c_street . '&c_barangay=' . $c_barangay . '&c_city=' . $c_city . '&c_province=' . $c_province . '&c_zipcode=' . $c_zipcode . '&p_street=' . $p_street . '&p_barangay=' . $p_barangay . '&p_city=' . $p_city . '&p_province=' . $p_province . '&p_zipcode=' . $p_zipcode . '&lname=' . $lname . '&fname=' . $fname . '&mname=' . $mname . '&gender=' . $gender . '&b_day=' . $b_day . '&mobile=' . $mobile . '&landline=' . $landline . '&e=Please fill up all the fields!');
        exit();
    }
}
                            ...
                            <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
                                <div class="row">
                                    <div class="offset-xxl-2 col-xxl-8">
                                        ...
                                        <form action="debtor/update_identity.php" method="post" id="kt_form" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Company Name</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_name" value="<?= isset($_GET['e']) ? $_GET['company_name'] : $_SESSION['company_name'] ?>" placeholder="Enter company name" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Monthly Salary</label> <span class="text-danger">*</span>
                                                        <input type="number" class="form-control form-control-solid form-control-lg" name="monthly_salary" value="<?= isset($_GET['e']) ? $_GET['monthly_salary'] : $_SESSION['monthly_salary'] ?>" placeholder="Enter company name" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_mobile" value="<?= isset($_GET['e']) ? $_GET['company_mobile'] : $_SESSION['company_mobile'] ?>" placeholder="Enter company mobile" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Landline No.</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_landline" value="<?= isset($_GET['e']) ? $_GET['company_landline'] : $_SESSION['company_landline'] ?>" placeholder="Enter company landline" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_email" value="<?= isset($_GET['e']) ? $_GET['company_email'] : $_SESSION['company_email'] ?>" placeholder="Enter company email" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_street" value="<?= isset($_GET['e']) ? $_GET['company_street'] : $_SESSION['company_street'] ?>" placeholder="Enter street" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Barangay</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_barangay" value="<?= isset($_GET['e']) ? $_GET['company_barangay'] : $_SESSION['company_barangay'] ?>" placeholder="Enter barangay" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_city" value="<?= isset($_GET['e']) ? $_GET['company_city'] : $_SESSION['company_city'] ?>" placeholder="Enter city" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label>Province</label> <span class="text-danger">*</span>
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_province" value="<?= isset($_GET['e']) ? $_GET['company_province'] : $_SESSION['company_province'] ?>" placeholder="Enter city" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="company_zipcode" value="<?= isset($_GET['e']) ? $_GET['company_zipcode'] : $_SESSION['company_zipcode'] ?>" placeholder="Enter zipcode" />
                                                    </div>
                                                </div>
                                            </div>
