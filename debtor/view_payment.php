								...
								<div class="card-body">
									<table class="table table-bordered">
										...
										<tbody>
											...
											$sql = "SELECT * FROM loan_application INNER JOIN user ON loan_application.lender_id = user.user_id 
											INNER JOIN running_balance ON loan_application.loan_app_id = running_balance.loan_app_id WHERE loan_application.debtor_id = $user_id";
											$query = $dbh->prepare($sql);
											$query->execute();
                                            ...
                                            <tr>
                                                <th scope="row"><?= $res['loan_app_id']?></th>
                                                <td><?= $res['company_name']?></td>
												<td><?= number_format($res['payment'],2)?></td>
												<td><?= $res['paid_date']?></td>
                                            </tr>
											<?php endforeach;?>
										</tbody>
