													...
													<div class="offset-xxl-2 col-xxl-8">
														<form action="" method="post" id="kt_form" enctype="multipart/form-data">
															...
															<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <div class="image-input image-input-outline" id="kt_image_1">
                                                                            <div class="image-input-wrapper" style="background-image: url(assets/keen/media/AP-NEW.png)"></div>
                                                                ...
                                                                $sql = "SELECT loan_application.*, user.* FROM loan_application INNER JOIN user on loan_application.debtor_id = user.user_id WHERE loan_application.id = $id";
                                                                $query = $dbh->prepare($sql);
                                                                $query->execute();
                                                                $user = $query->fetch();
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="mname" value="<?= $user['middlename'] ?>" />
                                                                    </div>
                                                                    </div>
                                                                </div>
																<!--end::Input-->
                                                                <div class="row">
																	...
																	<div class="col-lg-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="b_day" value="<?php $user['b_day']?>"  />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                <div class="row">
																	...
																	<div class="col-lg-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="landline" value="<?= $user['landline'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
															...
															<div class="pb-5" data-wizard-type="step-content">
                                                                ...
                                                                <div class="row">
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Street</label>
																			<input type="text" class="form-control" name="c_street" value="<?= $user['c_street'] ?>" placeholder="Enter street" />
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="c_baranagy" value="<?= $user['c_barangay'] ?>" placeholder="Enter barangay" />
																		</div>
																		<!--end::Input-->
																	</div>
                                                                    <div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="c_city" value="<?= $user['c_city'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                <div class="row">
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="c_city" value="<?= $user['c_province'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
                                                                    <div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="c_zipcode"value="<?= $user['c_zipcode']?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                ...
                                                                <div class="row">
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Street</label>
																			<input type="text" class="form-control" name="p_street" value="<?= $user['p_street'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Barangay</label>
																			<input type="text" class="form-control" name="p_baranagy" value="<?= $user['p_barangay'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
                                                                    <div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>City/Municipality</label>
																			<input type="text" class="form-control" name="p_city" value="<?= $user['p_city'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Zip Code</label>
																			<input type="text" class="form-control" name="p_zipcode" value="<?= $user['p_zipcode'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
															...
															<div class="pb-5" data-wizard-type="step-content">
                                                                ...
                                                                <div class="row">
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="company_name" value="<?= $res['company_name'];?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="company_name" value="<?= $res['monthly_salary'];?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                ...
                                                                <div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control" name="company_mobile" value="<?= $res['company_mobile'];?> " />
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-4">
                                                                    ...
                                                                    <div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Email Address.</label>
																			<input type="text" class="form-control" name="company-email" value=" <?= $res['company_email'];?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
																...
																<div class="row">
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Street</label>
																			<input type="text" class="form-control" name="p_street" value="<?= $res['company_street'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Barangay</label>
																			<input type="text" class="form-control" name="p_street" value="<?= $res['company_barangay'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
                                                                    <div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>City/Municipality</label>
																			<input type="text" class="form-control" name="p_street" value="<?= $res['company_city'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                <div class="row">
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Province</label>
                                                                            <input type="text" class="form-control" name="p_street" value="<?= $res['company_province'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			<label>Zip Code</label>
																			<input type="text" class="form-control" name="p_street" value="<?= $res['company_zipcode'] ?>"/>
																		</div>
																		<!--end::Input-->
                                                                        </div>
																</div>
															...
															<div class="pb-5" data-wizard-type="step-content">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label class="form-control-label" for="input-username">VALID ID</label>
                                                                            <div class="dropzone-panel mb-lg-0 mb-2">
                                                                            </div>
                                                                            <a href="/hulam2/assets/img/<?=$res['id_image']; ?>" target="_blank"><?= $res['id_image']; ?></a>
                                                                        </div>
                                                                    </div>
																</div>
                                                                <!--end::Input-->
                                                                ...
                                                                <div class="row">
																	<div class="col-xl-6">
																		...
																		<div class="form-group">
                                                                            ...
                                                                            <div class="dropzone-panel mb-lg-0 mb-2">
                                                                            <input type="text" class="form-control" name="rel_name" value=" <?= $res['relative_type'] ?>" />
																			</div>
																		</div>
																		<!--end::Input-->
																	</div>
																	<div class="col-xl-6">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="rel_name" value=" <?= $res['relative_name'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
																<div class="row">
																	<div class="col-xl-6">
																		...
																		<div class="form-group">
																			<label>Mobile No:</label>
																			<input type="text" class="form-control " name="rel_mobile" value=" <?= $res['relative_mobile'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                            ...
                                                            <div class="pb-5" data-wizard-type="step-content">
																<h4 class="mb-10 font-weight-bold text-dark">LOAN APPLICATION DETAILS</h4>
                                                                <div class="row">
																	<div class="col-xl-6">
																		<!--begin::Input-->
																		<div class="form-group">
                                                                            ...
                                                                            <div class="dropzone-panel mb-lg-0 mb-2">
                                                                            <input type="text" class="form-control" name="rel_name" value=" <?= $user['total_amount'] ?>" />
																			</div>
																		</div>
																		<!--end::Input-->
																	</div>
                                                                ...
                                                                <div class="row">
																	<div class="col-xl-6">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="rel_name" value=" <?= $user['months'] ?>" />
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
																<div class="row">
																	<div class="col-xl-6">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="rel_mobile" value=" <?= $user['monthly_payable'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
                                                                <div class="row">
																	<div class="col-xl-6">
																		...
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="rel_mobile" value=" <?= $user['date'] ?>"/>
																		</div>
																		<!--end::Input-->
																	</div>
																</div>
															...
															<div class="d-flex justify-content-between border-top mt-5 pt-10">
																...
																<div>
																	<button type="submit" name="submit" class="btn btn-success font-weight-bolder px-10 py-3" data-wizard-type="action-submit">Approved
																	</button>
																</div>
															</div>
															<!--end: Wizard Actions-->
