...
$sql2 = "SELECT * FROM loan_features WHERE lender_id = $user_id";
$query2 = $dbh->prepare($sql2);
$query2->execute();

if($query2->rowCount()==0){
	$sql3 = "INSERT INTO loan_features(lender_id,description)VALUES(:lender_id,:description)";
	$query3 = $dbh->prepare($sql3);
	$query3->bindParam(':lender_id',$user_id,PDO::PARAM_STR);
	$query3->bindParam(':description',$description,PDO::PARAM_STR);
	$query3->execute();
 }else{
	 $sql4 = "UPDATE loan_features SET description=:description WHERE lender_id =:lender_id";
...
if (isset($_POST['valid_id'])) {
	...
	$images3 = $_FILES['valid_id']['name'];
	$tmp_dir3 = $_FILES['valid_id']['tmp_name'];
	$imageSize3 = $_FILES['valid_id']['size'];
	...
	$valid_id = rand(1000, 10000000) . "." . $imgExt3;
	move_uploaded_file($tmp_dir3, $upload_dir3 . $valid_id);
	...
	if ($q->rowCount() == 0) 
	{
	$sql = "INSERT INTO loan_features(lender_id,valid_id)
	VALUES(:lender_id,:valid_id)";
		$query = $dbh->prepare($sql);
		$query->bindParam(':lender_id',$lender_id,PDO::PARAM_STR);
		$query->bindParam(':valid_id', $valid_id, PDO::PARAM_STR);
		$query->execute();
	} else{
		$sql = "UPDATE loan_features SET valid_id=:valid_id WHERE lender_id = $lender_id";
		$query = $dbh->prepare($sql);
		$query->bindParam(':valid_id', $valid_id, PDO::PARAM_STR);
	}
	if ($query->execute()) {
		$_SESSION['status'] = "Valid ID Updated!";
		header("location: update_profile.php");
		exit();
	} else {
...
if (isset($_POST['selfie_id'])) {
	...
	$images3 = $_FILES['selfie_id']['name'];
	$tmp_dir3 = $_FILES['selfie_id']['tmp_name'];
	$imageSize3 = $_FILES['selfie_id']['size'];

	$upload_dir3 = '../assets/keen/company_credentials/';
	$imgExt3 = strtolower(pathinfo($images3, PATHINFO_EXTENSION));
	$valid_extensions = array('jpeg', 'jpg', 'gif', 'pdf', 'doc', 'docx');
	$selfie_id = rand(1000, 10000000) . "." . $imgExt3;
	move_uploaded_file($tmp_dir3, $upload_dir3 . $selfie_id);
	...
	if ($q->rowCount() == 0) 
	{
	$sql = "INSERT INTO loan_features(lender_id,selfie_id)
	VALUES(:lender_id,:selfie_id)";
		$query = $dbh->prepare($sql);
		$query->bindParam(':lender_id',$lender_id,PDO::PARAM_STR);
		$query->bindParam(':selfie_id', $selfie_id, PDO::PARAM_STR);
		$query->execute();
	} else{
		$sql = "UPDATE loan_features SET selfie_id=:selfie_id WHERE lender_id = $lender_id";
		$query = $dbh->prepare($sql);
		$query->bindParam(':selfie_id', $selfie_id, PDO::PARAM_STR);
	}
	if ($query->execute()) {
		$_SESSION['status'] = "SELFIE ID Updated!";
		header("location: update_profile.php");
		exit();
	} else {
		$_SESSION['status'] = "Error!";
										...
										<div class="row">
											<div class="offset-xxl-2 col-xxl-8">
												<form action="" method="post" id="kt_form" enctype="multipart/form-data">
													...
													<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
														<h4 class="mb-10 font-weight-bold text-dark">Update Profile Information</h4>
														<form action="" method="post" id="kt_form" enctype="multipart/form-data">
															<div class="form-group row">
																<label class="col-xl-3 col-lg-3 col-form-label text-right"></label>
																<div class="col-lg-9 col-xl-6">
																	<div class="image-input image-input-outline" id="kt_image_1">
																	<div class="image-input-wrapper" style="background-image: url(/hulam/assets/keen/company_logo/<?= $red['profile_pic'] ?>"></div>
														...
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label text-right">Loan Description</label>
															<div class="col-lg-9 col-xl-6">
											...
											<div class="row">
												...
												<div class="col-xl-4">
													<div class="form-group">
														...
														<input type="date" class="form-control" required name="b_day" value="<?= isset($_GET['e']) ? $_GET['b_day'] :  $red['b_day'] ?>" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-xl-4">
													<div class="form-group">
														...
														<input maxlength="11" minlength="11" type="text" required="required" class="form-control" required name="mobile" placeholder="0900000000" value="<?= isset($_GET['e']) ? $_GET['mobile'] :  $red['mobile'] ?>" placeholder="Enter mobile number" />
												...
												<div class="col-xl-4">
													<div class="form-group">
														...
														<input maxlength="7" minlength="7" type="text" class="form-control" name="landline" placeholder="0000000" value="<?= isset($_GET['e']) ? $_GET['landline'] :  $red['landline'] ?>" placeholder="Enter landline number" />
											...
											<div class="row">
												<div class="col-xl-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="c_street" value="<?= isset($_GET['e']) ? $_GET['c_street'] : $red['c_street'] ?>" placeholder="Enter street" />
													</div>
												</div>
												<div class="col-xl-4">
													<div class="form-group">
														<label>Barangay</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="c_barangay" value="<?= isset($_GET['e']) ? $_GET['c_barangay'] : $red['c_barangay'] ?>" placeholder="Enter barangay" />
													</div>
												</div>
												<div class="col-xl-4">
													<div class="form-group">
														<label>City/Municipality</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="c_city" value="<?= isset($_GET['e']) ? $_GET['c_city'] : $red['c_city'] ?>" placeholder="Enter city" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-xl-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" required name="c_province" value="<?= isset($_GET['e']) ? $_GET['c_province'] : $red['c_province'] ?>" placeholder="Enter barangay" />
													</div>
												</div>
												<div class="col-xl-4">
													<div class="form-group">
														<label>Zip Code</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="c_zipcode" value="<?= isset($_GET['e']) ? $_GET['c_zipcode'] : $red['c_zipcode'] ?>" placeholder="Enter zipcode" />
											...
											<div class="row">
												<div class="col-xl-4">
													<div class="form-group">
														<label>Street</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" name="p_street" value="<?= isset($_GET['e']) ? $_GET['p_street'] : $red['p_street'] ?>" placeholder="Enter street" />
													</div>
												</div>
												<div class="col-xl-4">
													<div class="form-group">
														<label>Barangay</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="p_barangay" value="<?= isset($_GET['e']) ? $_GET['p_barangay'] : $red['p_barangay'] ?>" placeholder="Enter barangay" />
													</div>
												</div>
												<div class="col-xl-4">
													<div class="form-group">
														<label>City/Municipality</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="p_city" value="<?= isset($_GET['e']) ? $_GET['p_city'] :$red['p_city'] ?>" placeholder="Enter city" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-xl-4">
													<div class="form-group">
														<label>Province</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="p_province" value="<?= isset($_GET['e']) ? $_GET['p_province'] : $red['p_province'] ?>" placeholder="Enter barangay" />
													</div>
												</div>
												<div class="col-xl-4">
													<div class="form-group">
														<label>Zip Code</label> <span class="text-danger">*</span>
														<input type="text" class="form-control" required name="p_zipcode" value="<?= isset($_GET['e']) ? $_GET['p_zipcode'] : $red['p_zipcode'] ?>" placeholder="Enter zipcode" />
														<label><span style="color:green">&#x2714;</span><span style="font-family: Courier New; font-size: 11px"> Atleast 4 digits</label></span>
													</div>
												</div>
											</div>
											<div class="d-flex justify-content-between border-top mt-5 pt-10">
												<div></div>
												<div>
													<button type="submit" name="submit_file" class="btn btn-success font-weight-bolder px-10 py-3">Submit</button>
												</div>
											</div>
										</form>
										...
										<div class="row">
											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													$sql = "SELECT * FROM loan_features WHERE lender_id = $user_id";
													$query = $dbh->prepare($sql);
													$query->execute();
													...
													?>
															<tr>
																...
																<td><a href="/hulam/assets/keen/company_credentials/<?= htmlentities($res->valid_id) ?>" target="_blank"><?= htmlentities($res->valid_id); ?></a></td>
															...
															<tr>
																...
																<td><a href="/hulam/assets/keen/company_credentials/<?= htmlentities($res->selfie_id) ?>" target="_blank"><?= htmlentities($res->selfie_id); ?></a></td>
