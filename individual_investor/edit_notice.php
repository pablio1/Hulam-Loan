											...
											<div class="row">
												<div class="offset-xxl-2 col-xxl-8">
                                                    ...
                                                    <?php
														...
														?>
                                                        <h4 class="mb-10 font-weight-bold text-dark"><?= $res['notice_title']?></h4>
                                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <div class="form-group">
																	<input type="hidden" name="notice_title[]" value="Notice Upon Submission of Loan Requirements">
																	<textarea name="remarks" class="form-control"  rows="4" cols="50"  autocomplete="off" value="Remarks"><?= $res['remarks'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
