							...
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								...
								<div class="menu-submenu">
									<ul class="menu-subnav">
										...
										<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
											<a href="individual_investor/view_payment.php" class="menu-link menu-toggle">
												<span class="svg-icon menu-icon">
												</span>
						...
						<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									...
									<h5 class="text-white font-weight-bold my-1 mr-5"><?php echo $_SESSION['firstname']; ?> <?php echo $_SESSION['lastname']; ?></h5>
									<!--end::Page Title-->
								</div>
								<!--end::Page Heading-->
							</div>
								...
								<div class="col-lg-4">
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-footer border-0 d-flex align-items-center justify-content-between pt-0">
											<span></span>
											<a href="individual_investor/pending_loan.php" class="btn btn-sm btn-primary font-weight-bolder px-6">View</a>
										</div>
									</div>
								</div>
								<div class="col-lg-4">
									...
									<div class="card-footer border-0 d-flex align-items-center justify-content-between pt-0">
										<span></span>
										<a href="individual_investor/approvedloan.php" class="btn btn-sm btn-primary font-weight-bolder px-6">View</a>
									</div>
								</div>
							</div>
							<div class="col-lg-4">
								...
								<div class="card-footer border-0 d-flex align-items-center justify-content-between pt-0">
									<span></span>
									<a href="individual_investor/payment_received.php" class="btn btn-sm btn-primary font-weight-bolder px-6">View</a>
								</div>
							</div>
						</div>
					</div>
