										...
										<ul class="menu-subnav">
											...
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="lending_company/pending_loan.php" class="menu-link menu-toggle">
													...
													<span class="menu-text">Pending Payment</span>
													<span class="menu-label">
													</span>
													<i class="menu-arrow"></i>
												</a>
								...
								<div class="row">
									<div class="col-lg-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-6">
												<h3 class="card-title">
													<span class="card-label font-weight-bolder font-size-h4 text-dark-75">Pending Loan Application</span>
												</h3>
									...
									<div class="col-lg-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-6">
												<h3 class="card-title">
													<span class="card-label font-weight-bolder font-size-h4 text-dark-75">Approved Loan Application</span>
												</h3>
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
														<a href="#" class="btn btn-icon-primary btn-clean btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									...
									<div class="col-lg-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-6">
												<h3 class="card-title">
													<span class="card-label font-weight-bolder font-size-h4 text-dark-75">Payment Received</span>
												</h3>
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
														<a href="#" class="btn btn-icon-primary btn-clean btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
