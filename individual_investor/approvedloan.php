										...
										<div class="tab-content mt-9" id="myTabMixed2">
											...
											<div class="tab-pane fade active show" id="kt_tab_mixed_2_1" role="tabpanel" aria-labelledby="kt_tab_mixed_2_1">
												...
												<div class="card card-custom">
													<div class="card-body">
														<h5> Approved Loan Application</h5>
														<table class="table table-bordered">
															...
															<?php
																...
																$sql = "SELECT loan_application.*, user.* FROM loan_application INNER JOIN user ON loan_application.debtor_id = user.user_id WHERE loan_application.lender_id = '$lender_id' AND loan_application.status = 'approved'";
																$query = $dbh->prepare($sql);
																$query->execute();
																...
																<tr>
																	...
																	<td>
																		<a href="individual_investor/view_application.php?id=<?= htmlentities($rem->id)?>" class="kt-nav__link">
