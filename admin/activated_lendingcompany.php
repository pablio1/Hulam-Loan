...
<html lang="en">
	...
	<head><base href="../index.php">
		<meta charset="utf-8" />
		<title>Activated Lending Companies</title>
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container">
							<div class="card card-custom">
								<div class="card-body">
									<h5>List of Activated Lending Company</h5>
									...
									<table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                            $sql = "SELECT  * FROM user WHERE user_type = '3' AND eligible = 'yes'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/view_lendingcompany_info.php?user_id=<?= htmlentities($rem->user_id) ?>" class="kt-nav__link">
