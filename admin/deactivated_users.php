					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container">
							<div class="card card-custom">
								<div class="card-body">
									<h5>List of Deactivated Account</h5>
									...
									<table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                            $sql = "SELECT  * FROM loan_features INNER JOIN user ON loan_features.lender_id OR loan_features.paycenter_id = user.user_id WHERE user.eligible = 'deactivated' AND user_type !='1'";
                                            ...
                                            <tr>
                                                <td>
												<?php if($rem['user_type']=='3' || $rem['user_type']=='5'):?>
													<?= $rem['company_name'] ?></td>
                                                <?php else:?>
													<?= $rem['firstname'].' '.$rem['middlename'].' '.$rem['lastname'] ?>
												<?php endif;?>
													<td><?= $rem['email']; ?></td>
													<td>Mobile: <?= $rem['mobile']; ?></td>
                                                <td>
												<?php if($rem['user_type']=='3' || $rem['user_type']=='5'):?>
													<?= $rem['company_street'].' '.$rem['company_barangay'].' '.$rem['company_city'].' '.$rem['company_province'].' '.$rem['company_zipcode']?>
												<?php else:?>
													<?= $rem['c_street'].' '.$rem['c_barangay'].' '.$rem['c_city'].' '.$rem['c_province'].' '.$rem['c_zipcode'] ?>
												<?php endif;?>
												</td>
                                                <td>
                                                <?php if($rem['user_type']=='3' || $rem['user_type']=='5'):?>
													<a href="admin/view_lendingcompany_request.php?user_id=<?= $rem['user_id']?>">View</a>
												<?php elseif($rem['user_type']=='4'):?>
													<a href="admin/view_individaulinvestor_request.php?user_id=<?= $rem['user_id']?>">View</a>
												<?php else:?>	
													<a href="admin/view_request.php?user_id=<?= $rem['user_id']?>">View</a>
												<?php endif;?>	
                                                </td>
												<?php endforeach; }?>
                                            </tr>
