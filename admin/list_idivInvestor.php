									...
									<div class="card-body p-0">
										...
										<div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
											...
											<div class="row">
												...
												<h5 class="mb-10 font-weight-bold text-dark">List of Individual Investors</5>	
                                                ...
                                                <table class="table table-bordered">
													...
													<?php
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($res as $rem) { ?>
                                                        <tr>
                                                            <td><?= htmlentities($rem->firstname); ?>&nbsp;<?= htmlentities($rem->middlename); ?>&nbsp;<?= htmlentities($rem->middlename); ?></td>
