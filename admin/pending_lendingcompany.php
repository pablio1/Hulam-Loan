...
<html lang="en">
	...
	<head><base href="../index.php">
		<meta charset="utf-8" />
		<title>Pending Lending Company Accounts </title>
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container">
							<div class="card card-custom">
								<div class="card-body">
									<h5> Pending Lending Company Activation</h5>
									...
									<table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                            $sql = "SELECT  * FROM user INNER JOIN loan_features ON loan_features.lender_id = user.user_id WHERE user_type = '3' AND eligible ='no' ORDER BY user_id desc";
                                            ...
                                            <tr>
                                                ...
                                                <td><?= htmlentities($rem->company_street); ?>&nbsp;<?= htmlentities($rem->company_barangay); ?>&nbsp;<?= htmlentities($rem->company_city); ?>&nbsp;<?= htmlentities($rem->company_province); ?>&nbsp;<?= htmlentities($rem->company_zipcode); ?></td>
                                                <td>
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item"> 
																	<a href="admin/view_lendingcompany_request.php?user_id=<?= htmlentities($rem->user_id) ?>" class="navi-link"> <span class="navi-icon"><i class="la la-copy"></i></span> <span class="navi-text">Show Details</span> </a> </li>
															</ul>
														</div>
													</div>
												</td>
