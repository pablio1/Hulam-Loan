...
if (isset($_POST['sign_up'])) {
    ...
    $sql = $dbh->prepare("INSERT INTO user (user_type,company_name,email,mobile,password,status,eligible,token) VALUES (:user_type,:company_name,:email,:mobile,:password,'unverified','no',:token)");
