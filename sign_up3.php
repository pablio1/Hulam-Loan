                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 col-md-6">
                        <div class="payment_form white-bg wow fadeInDown" data-wow-duration="1.2s" data-wow-delay=".2s">
                            <div class="info text-center">
                                ...
                                <?php if (isset($_GET['m'])) : ?>
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <strong><i class="fa fa-check"></i></strong> <?= $_GET['m'] ?>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                            ...
                            <form class="form" id="sign_up_form" action="logic/sign_up3.php" method="post" autocomplete="off">
                                <div class="form">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Last Name" type="text" name="lastname" value="<?= isset($_GET['lname']) ? $_GET['lname'] : '' ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="First Name" type="text" name="firstname" value="<?= isset($_GET['fname']) ? $_GET['fname'] : '' ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Middle Name" type="text" name="middlename" value="<?= isset($_GET['mname']) ? $_GET['mname'] : '' ?>" />
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Email" type="text" name="email" value="<?= isset($_GET['email']) ? $_GET['email'] : '' ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" required placeholder="Phone" type="text" name="mobile" value="<?= isset($_GET['mobile']) ? $_GET['mobile'] : '' ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Password" type="password" name="password" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                ...
                                <div class="submit_btn">
                                    <input type="hidden" name="usertype" value="<?= $_GET['id'] ?>">
                                    <button class="boxed-btn3" type="submit" name="sign_up" id="submit_sign_up"><i class="fa fa-spinner fa-spin hide"></i> <span class="btn-text">Submit</span></button>
                                </div>
                                </br><span >Already have an account? <a href="login.php"><i style="color:blue">Log in here</i></a></span>
                            </form>
                        </div>
                    </div>
                </div>
