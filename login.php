                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control form-control-solid h-auto p-6 rounded-lg" style="padding:10px" placeholder="Email" type="text" name="email" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control form-control-solid h-auto p-6 rounded-lg" style="padding:10px" placeholder="Password" type="password" name="password" />
                                            </div>
                                        </div>
