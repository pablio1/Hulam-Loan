                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 col-md-6">
                        <div class="payment_form white-bg wow fadeInDown" data-wow-duration="1.2s" data-wow-delay=".2s">
                            ...
                            <form class="from" method="post" action="logic/forgot.php" id="changepass_form" autocomplete="off">
                                <div class="form">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Email" type="text" name="email" />
                                        </div>
                                    </div>
                                </div>
                                <div class="submit_btn">
                                    <button class="boxed-btn3" type="submit" name="forgot"><i class="fa fa-spinner fa-spin hide"></i> <span class="btn-text">Reset</span></button>
                                </div></br>
                                <a href="login.php" class="row align-items-center justify-content-center">Back to login</a>
                            </form>
                        </div>
                    </div>
                </div>
