											...
											<div class="card-body">
												...
												<table class="table table-bordered">
													...
													<tbody>
                                                        ...
                                                        $sql = "SELECT * FROM payment_details INNER JOIN loan_application ON payment_details.loan_id = loan_application.id  WHERE payment_details.remittance_id = $user_id";
														...
														<tr>
                                                            <td><?= $res['id']?></td>
                                                            <td><?= $res['l_name']?>&nbsp;<?= $res['f_name']?>&nbsp;<?= $res['m_name']?></td>
                                                            <td><?= $res['phone_no']?></td>
                                                            <td><?= $res['lending_company_name']?></td>
                                                            <td><?= $res['bank_name']?></td>
