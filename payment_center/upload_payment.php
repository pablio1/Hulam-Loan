...
if(isset($_POST['submit'])){
    ...
    $remittance_id = $_SESSION['user_id'];
	$loan_id = $_POST['loan_id'];
	$l_name = $_POST['l_name'];
	$f_name = $_POST['f_name'];
	$m_name = $_POST['m_name'];
	$phone_no = $_POST['phone_no'];
	$lending_company_name = $_POST['lending_company_name'];
	...
	$sql = "INSERT INTO payment_details(remittance_id,loan_id,l_name,f_name,m_name,phone_no,lending_company_name,bank_name,bank_account_no,payment_date,reference_no,amount_paid,posted_date,confirm)VALUES(:remittance_id,:loan_id,:l_name,:f_name,:m_name,:phone_no,:lending_company_name,:bank_name,:bank_account_no,:payment_date,:reference_no,:amount_paid,:posted_date,:confirm)";
	$query = $dbh->prepare($sql);
    $query->bindParam(':remittance_id',$remittance_id,PDO::PARAM_STR);
	...
	$query->bindParam(':lending_company_name',$lending_company_name,PDO::PARAM_STR);
	...
	$query->bindParam(':reference_no',$reference_no,PDO::PARAM_STR);
	$query->bindParam(':amount_paid',$amount_paid,PDO::PARAM_STR);
	$query->bindParam(':posted_date',$posted_date,PDO::PARAM_STR);
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex flex-wrap flex-row-fluid">
																...
																<div class="d-flex flex-column pr-5 flex-grow-1">
																	...
																	<span class="text-muted font-weight-bold">UI/UX, Art Directquicor</span>
																</div>
																<!--end::Text-->
																<!--begin::Section-->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap">
									...
									<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="top">
										<a href="payment_center/upload_payment.php" class="btn btn-fixed-height btn-primary btn-text-white-50 btn-hover-text-white font-weight-bolder font-size-sm px-5 my-1 mr-3" aria-haspopup="true" aria-expanded="false">
										Add Payment</a>
									</div>
									<!--end::Dropdown-->
                                                                ...
                                                                <div class="row">
																	<div class="col-lg-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control " name="lending_company_name"/>
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
		...
		<div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
			...
			<div class="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
				<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary flex-grow-1 px-10" role="tablist">
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab">Notifications</a>
					</li>
				</ul>
