...
if(isset($_POST['send_message'])){
    ...
    $lender_id = $_POST['receiver_id'];
    $message = $_POST['message'];
    $date_message = $_POST['date_message'];

    $sql = "INSERT INTO message(sender_id,receiver_id,message,date_message)VALUES(:sender_id,:receiver_id,:message,:date_message)";
    ...
    if($query->execute()){
        ...
        header("Location: send_message.php?user_id=$lender_id");
        exit();
    }else{
        $_SESSION['status']="Error Sending Message!";
        header("Location: send_message.php?user_id=$lender_id");
        exit();
    }
}
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-5">
                                                    ...
                                                    <div>
                                                        <?php
                                                            ...
                                                            <input type="hidden" name="receiver_id" value="<?= intval($_GET['user_id'])?>">
