											...
											<div class="card-body">
												<div id="stats-widget-slider-1">
													<div class="d-flex align-items-center justify-content-between flex-wrap">
														<span class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">Upload Payment</span>
														<div class="p-0">
														</div>
													</div>
													<div class="symbol symbol-100 mr-5">
														<img src="assets/admin/media/users/icon-company.jpg" />
													</div>
												</div>
											</div>
									...
									<div class="col-lg-4">
										<div class="card card-custom card-stretch gutter-b">
											<div class="card-body">
												<div id="stats-widget-slider-1">
													<div class="d-flex align-items-center justify-content-between flex-wrap">
														<span class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">Uploaded Payment</span>
														<div class="p-0">
														</div>
													</div>
													<div class="symbol symbol-100 mr-5">
