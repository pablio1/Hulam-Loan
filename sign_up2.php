                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 col-md-6">
                        <div class="payment_form white-bg wow fadeInDown" data-wow-duration="1.2s" data-wow-delay=".2s">
                            ...
                            <form class="form" id="sign_up_form" action="logic/sign_up.php" method="post" autocomplete="off">
                                <div class="form">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Company Name" type="text" name="company_name" value="<?= isset($_GET['company_name']) ? $_GET['company_name'] : '' ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
